...
| Métrica | Valor | Fonte |
|---------|-------|-------|
| Tests | **1041/1041** ✅ default + **18/18** ✅ test:soak (deep-soak isolado) | `vitest run` 2026-05-12 |
| Test files | 91 | `find tests -name "*.test.js"` |
| Specs totais | **110** | `find specs -name "SPEC-*.md"` |

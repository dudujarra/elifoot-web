/**
 * BenchEventsDeck — SPEC-179
 *
 * Bench Events — 12 cartas
...
export interface BenchEvent {
    ...
    readonly options: readonly BenchOption[];
}

export const BenchEventsDeck: readonly BenchEvent[] = [

 ...
 */
export interface OffPitchEventEffect {
    fans?: number;
    sponsors?: number;
    boss?: number;
    teammates?: number;
...
export interface OffPitchEventOption {
    label: string;
    effect: OffPitchEventEffect;
    resultText: string;
    flags?: {
        set?: string;
        clear?: string;
...
export interface OffPitchEvent {
    id: string;
    trigger: (player: any) => boolean;
    text: string;
    options: OffPitchEventOption[];
}

export const OffPitchEventsDeck: OffPitchEvent[] = [
  // === SEMPRE DISPONÍVEIS ===

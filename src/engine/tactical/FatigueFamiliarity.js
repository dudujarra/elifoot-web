 ...
 */
export function applyFatigue(baseAttribute, attributeType, currentFitness) {
 ...
 */
export function calculateFitnessDecayPerMinute(stamina, naturalFitness, teamStyle) {
    let intensity = 1.0;
 ...
 */
export function applyTacticalFamiliarity(effectiveQuality, tacticalFamiliarity) {
 ...
 * @returns {number} The modified quality
 */
export function applyMoraleAndForm(effectiveQuality, morale, form) {

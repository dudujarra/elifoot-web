 ...
 */
export function getFormationMultipliers(formA, formB) {
    // Determine base advantage from matrix
    const baseMultA = (BASE_MULTIPLIERS[formA] && BASE_MULTIPLIERS[formA][formB]) || 1.0;
 ...
 */
export function mapFormationToKey(formationString) {

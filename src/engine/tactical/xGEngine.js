 ...
 */
export function calculateShotxG(x, y, defendersAhead, shooter) {
 ...
 */
export function resolveShot(xG, goalkeeper) {
...
export function getExpectedThreat(x, y) {
    if (x < 0 || x > 4 || y < 0 || y > 5) return 0;
    return BASE_XT_GRID[y][x];
}

export function evaluatePassValue(startX, startY, endX, endY) {

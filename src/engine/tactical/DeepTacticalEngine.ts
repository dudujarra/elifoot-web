...
export class DeepTacticalEngine {
     ...
     */
    initializeMatch(homeTeam: Team, awayTeam: Team) {
        this.grid.clearGrid();
    ...
    attemptShot(team: 'home' | 'away', _squad: unknown) {
    ...
    matchState: {
        ...
        homeScore: number,
        awayScore: number,
        homeStats: { xG: number, shots: number },
        awayStats: { xG: number, shots: number },
        possession: 'home' | 'away'
    };
    homeTeam!: Team;
    awayTeam!: Team;
    formationMultipliersHome!: number[];
    formationMultipliersAway!: number[];
}

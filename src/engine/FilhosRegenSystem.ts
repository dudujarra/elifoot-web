...
interface EvaluateOpts {
    ...
    saveYear?: number;
    season?: number;
    formerCompanions?: FormerCompanion[];
    seed?: number | null;
}
...
export function evaluate({
    ...
    const eligible = formerCompanions.filter((c: FormerCompanion) => {
...
function buildRegen(parent: FormerCompanion, rand: () => number): Regen {

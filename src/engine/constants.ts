...
export const PROMOTION_BONUS: Record<number, number> = {
...
export interface LuxuryTaxBracket {
    threshold: number;
    rate: number;
}

/** Progressive luxury tax brackets */
export const LUXURY_TAX_BRACKETS: LuxuryTaxBracket[] = [
...
export const CONTRACT_DURATION: Record<string, number> = {
    NEW_HIRE: 1,
    RENEWAL: 2,
};
...
export const CLIMATE_ZONES: string[] = ['TROPICAL', 'COLD', 'ALTITUDE', 'RAINY'];
...
export const WEATHER_DRAIN: Record<string, number> = {
    NORMAL: 1.0,
    COLD: 1.1,
    HOT: 1.2,
    RAIN: 1.25,

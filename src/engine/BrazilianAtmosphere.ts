...
export function getAtmosphere(eventType: string, seed: number = 0): AtmosphereResult {
 ...
 * @returns {string[]}
 */
export function getAtmosphereSet(eventType: string, count: number = 3, seed: number = 0): string[] {
    const list = ATMOSPHERE[eventType] || [];
